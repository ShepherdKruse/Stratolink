...
1. [RAK3172](https://www.digikey.com/en/products/detail/rakwireless-technology-limited/RAK3172-9-SM-NI/17138034) LoRaWAN Module (STM32WLE5)
    - w/ some wire monopole att (multi band [868/915/923 MHz] we ant to target center frequency ~900 MHz)
...
2. uBlox [MAX-M10S-00B](https://www.digikey.com/en/products/detail/u-blox/MAX-M10S-00B/15712906)
    - no EEPROM, need soemthign like `CFG-NAVSPG-DYNMODEL=8` sent after each restart
...
- Standard FR4 (0.4mm maybe) feels sufficent here, *maybe* flexi offers marginal benefit, yet I imagine also signficantly impeades design

- *I still need to spec out perpherials for all components on this list, for now this is just the high level stuff*
